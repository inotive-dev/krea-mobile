...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    //     title: Text(Strings.history, style: TextStyle(color: ColorPalettes.darkBlue, fontSize: Sizes.sp18)),
    //     centerTitle: true,
    //     elevation: 0,
    //   ),
    //   AppBar(
    //     backgroundColor: ColorPalettes.greyAppBar,
    //     title: Text(Strings.profile, style: TextStyle(color: ColorPalettes.darkBlue, fontSize: Sizes.sp18)),
    //     centerTitle: true,
    //     elevation: 0,
    //   ),
    // ];
