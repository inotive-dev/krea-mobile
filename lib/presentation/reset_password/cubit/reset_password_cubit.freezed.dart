...
class _$_ResetPasswordState implements _ResetPasswordState {
  ...
  @override
  String toString() {
    return 'ResetPasswordState(sendEmailResultState: $sendEmailResultState, sendOTPResultState: $sendOTPResultState, sendResetPasswordResultState: $sendResetPasswordResultState, resetStep: $resetStep, validOtp: $validOtp)';
  }
