...
part of 'sales_report_data_entity.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SalesReportDataEntityAdapter extends TypeAdapter<SalesReportDataEntity> {
  @override
  final int typeId = 16;

  @override
  SalesReportDataEntity read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return SalesReportDataEntity(
      currentPage: fields[0] as int?,
      data: (fields[1] as List?)?.cast<SalesResponseEntity>(),
  ...
  @override
  void write(BinaryWriter writer, SalesReportDataEntity obj) {
    writer
      ..writeByte(13)
      ..writeByte(0)
  ...
  bool operator ==(Object other) =>
      ...
      other is SalesReportDataEntityAdapter &&
