...
part of 'sales_report_entity.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SalesReportEntityAdapter extends TypeAdapter<SalesReportEntity> {
  @override
  final int typeId = 9;

  @override
  SalesReportEntity read(BinaryReader reader) {
    ...
    return SalesReportEntity(
      ...
      mart: fields[17] as MartEntity?,
    );
  }

  @override
  void write(BinaryWriter writer, SalesReportEntity obj) {
    writer
      ..writeByte(18)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is SalesReportEntityAdapter &&
