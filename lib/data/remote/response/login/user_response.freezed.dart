...
class _$_UserResponse extends _UserResponse {
  const _$_UserResponse(
      ...
      @JsonKey(name: 'marriage_status') required this.marriageStatus,
      required this.address,
      @JsonKey(name: 'employee_status') required this.employeeStatus,
      ...
      @JsonKey(name: 'deleted_at') required this.deleteAt,
