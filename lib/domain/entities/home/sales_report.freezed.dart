...
/// @nodoc
class _$SalesReportCopyWithImpl<$Res> implements $SalesReportCopyWith<$Res> {
  _$SalesReportCopyWithImpl(this._value, this._then);

  final SalesReport _value;
  // ignore: unused_field
...
class _$_SalesReport implements _SalesReport {
  const _$_SalesReport(
      {required this.id,
