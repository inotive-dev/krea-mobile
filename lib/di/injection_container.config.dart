...
import '../core/utils/network_info/network_info.dart' as _i6;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i4.HiveManager>(() => registerModule.hiveManager());
  gh.lazySingleton<_i5.LocalDataSource>(
      () => _i5.LocalDataSource(get<_i4.HiveManager>()));
  gh.lazySingleton<_i6.NetworkInfoImpl>(() => registerModule.networkInfoImpl());
  gh.factory<String>(() => registerModule.baseUrl, instanceName: 'BaseUrl');
  gh.lazySingleton<_i7.Dio>(() => registerModule.dio(
      get<String>(instanceName: 'BaseUrl'), get<_i5.LocalDataSource>()));
