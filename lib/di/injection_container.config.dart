...
import '../domain/usecases/get_home_admin_perubahan_modal_usecase.dart' as _i20;
import '../domain/usecases/get_home_admin_sales_reports.dart' as _i21;
import '../domain/usecases/get_home_admin_usecase.dart' as _i22;
import '../domain/usecases/get_home_user_usecase.dart' as _i23;
import '../domain/usecases/get_profile.dart' as _i24;
import '../domain/usecases/get_user_usecase.dart' as _i25;
import '../domain/usecases/update_profile.dart' as _i12;
import '../presentation/auth/cubit/login_cubit.dart' as _i28;
import '../presentation/history/cubit/history_cubit.dart' as _i26;
import '../presentation/home/cubit/home_cubit.dart' as _i27;
import '../presentation/profile/cubit/profile_cubit.dart' as _i29;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i20.GetHomeAdminPerubahanModal>(() =>
      _i20.GetHomeAdminPerubahanModal(myRepository: get<_i10.MyRepository>()));
  gh.lazySingleton<_i21.GetHomeAdminSalesReports>(() =>
      _i21.GetHomeAdminSalesReports(myRepository: get<_i10.MyRepository>()));
  gh.lazySingleton<_i22.GetHomeAdminUseCase>(
      () => _i22.GetHomeAdminUseCase(myRepository: get<_i10.MyRepository>()));
  gh.lazySingleton<_i23.GetHomeUserUseCase>(
      () => _i23.GetHomeUserUseCase(myRepository: get<_i10.MyRepository>()));
  gh.lazySingleton<_i24.GetProfileUseCase>(
      () => _i24.GetProfileUseCase(myRepository: get<_i10.MyRepository>()));
  gh.lazySingleton<_i25.GetUserUseCase>(
      () => _i25.GetUserUseCase(myRepository: get<_i10.MyRepository>()));
  gh.factory<_i26.HistoryCubit>(() => _i26.HistoryCubit(
      get<_i16.GetHistoryAdminUseCase>(), get<_i17.GetHistoryUserUseCase>()));
  gh.factory<_i27.HomeCubit>(() => _i27.HomeCubit(
      get<_i22.GetHomeAdminUseCase>(),
      get<_i23.GetHomeUserUseCase>(),
      get<_i19.GetHomeAdminNeraca>(),
      get<_i18.GetHomeAdminLabaRugi>(),
      get<_i21.GetHomeAdminSalesReports>(),
      get<_i20.GetHomeAdminPerubahanModal>()));
  gh.factory<_i28.LoginCubit>(
      () => _i28.LoginCubit(get<_i14.DoLoginUseCase>()));
  gh.factory<_i29.ProfileCubit>(() => _i29.ProfileCubit(
      get<_i15.DoLogoutUseCase>(),
      get<_i25.GetUserUseCase>(),
      get<_i24.GetProfileUseCase>(),
